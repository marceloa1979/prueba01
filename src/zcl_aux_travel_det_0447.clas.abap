CLASS zcl_aux_travel_det_0447 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_travel_reported      TYPE TABLE FOR REPORTED z_i_travel_0447,
           tt_booking_reported     TYPE TABLE FOR REPORTED z_i_booking_0447,
           tt_supplements_reported TYPE TABLE FOR REPORTED z_i_booksuppl_0447.
...
CLASS zcl_aux_travel_det_0447 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA: it_travel_id TYPE tt_travel_id.
    APPEND 7  TO  it_travel_id.
    zcl_aux_travel_det_0447=>calculate_price(  it_travel_id = it_travel_id  ).
  ...
  METHOD calculate_price.
    ...
    READ ENTITIES OF z_i_travel_0447  ENTITY Travel
    ...
    READ ENTITIES OF z_i_travel_0447 ENTITY Travel BY \_Booking
