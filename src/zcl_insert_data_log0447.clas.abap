CLASS zcl_insert_data_log0447 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_insert_data_log0447 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA: lt_travel   TYPE TABLE OF ztb_trvl_usr0447,
          lt_booking  TYPE TABLE OF ztb_bkng_usr0447,
          lt_book_sup TYPE TABLE OF ztb_bksp_usr0447.
    ...
    DELETE FROM: ztb_trvl_usr0447,  ztb_bkng_usr0447, ztb_bksp_usr0447.

    INSERT: ztb_trvl_usr0447  FROM TABLE @lt_travel,
            ztb_bkng_usr0447  FROM TABLE @lt_booking,
            ztb_bksp_usr0447  FROM TABLE @lt_book_sup.
