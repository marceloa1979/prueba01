CLASS lcl_buffer DEFINITION.
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_buffer_master.
             INCLUDE TYPE zhc_master_0447 AS data.
...
CLASS lhc_HCMMaster IMPLEMENTATION.
  ...
  METHOD create.
    ...
    SELECT MAX( e_number ) FROM zhc_master_0447
  ...
  METHOD update.
    ...
    LOOP AT entities INTO DATA(ls_entities).
      ...
      SELECT SINGLE * FROM zhc_master_0447
...
CLASS lsc_HCM_MASTER_0447 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_HCM_MASTER_0447 IMPLEMENTATION.
  ...
  METHOD save.
    ...
    DATA: lt_data_created TYPE STANDARD TABLE OF zhc_master_0447,
          lt_data_updated TYPE STANDARD TABLE OF zhc_master_0447,
          lt_data_deleted TYPE STANDARD TABLE OF zhc_master_0447.
    ...
    IF NOT lt_data_created IS INITIAL.
      INSERT zhc_master_0447 FROM TABLE @lt_data_created.
    ENDIF.
    ...
    IF NOT lt_data_updated IS INITIAL.
      UPDATE zhc_master_0447 FROM TABLE @lt_data_updated.
    ENDIF.
    ...
    IF NOT lt_data_deleted IS INITIAL.
      DELETE zhc_master_0447 FROM TABLE @lt_data_deleted.
    ENDIF.
