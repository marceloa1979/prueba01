CLASS zcl_virt_elem_0447 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_virt_elem_0447 IMPLEMENTATION.

  METHOD if_sadl_exit_calc_element_read~get_calculation_info.

    IF iv_entity = 'Z_C_TRAVEL_0447'.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    DATA lt_original_data TYPE STANDARD TABLE OF z_c_travel_0447 WITH DEFAULT KEY.
